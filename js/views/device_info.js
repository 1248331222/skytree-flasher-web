...
function updateBtnState() {
    ...
    setDisabled('batchFlashBtn', !flashModeUsable || stepList.length === 0);
    setDisabled('rebootSysBtn', !anyUsable);
    setDisabled('rebootRecBtn', !anyUsable);
    setDisabled('rebootFbBtn', !anyUsable);
    setDisabled('rebootBootloaderBtn', !anyUsable);
    setDisabled('readDeviceInfoBtn', !fastbootUsable);
    setDisabled('querySlotBtn', !fastbootUsable);
    setDisabled('runCustomFastbootBtn', !fastbootUsable);
    ...
    setDisabled('setSlotBtn', !fastbootUsable);
    setDisabled('wipeBtn', !fastbootUsable);
    setDisabled('wipeMetadataBtn', !fastbootUsable);
    setDisabled('checkBlBtn', !fastbootUsable);
    setDisabled('unlockBlBtn', !fastbootUsable);
    setDisabled('lockBlBtn', !fastbootUsable);
    setDisabled('simulateBtn', stepList.length === 0);
    setDisabled('clearBatchStepsBtn', stepList.length === 0);
